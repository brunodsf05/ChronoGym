exercises = [
    ...
    {
        "name": "@kettlebell_power",
        "icon": "/generic/kettlebell",
        "tags": [
            "@gym",
            "@kettlebell",
            "@fullbody",
        ...
        "exercise": {
            "poses": [
                {
                    "id": "kettlebell_swing_back",
                    "name": "@kettlebell_swing_back",
                    "icon": "/pose/kettlebell_swing_back",
                },
                {
                    "id": "kettlebell_swing_forward",
                    "name": "@kettlebell_swing_forward",
                    "icon": "/pose/kettlebell_swing_forward",
                },
                {
                    "id": "kettlebell_squat_down",
                    "name": "@kettlebell_squat_down",
                    "icon": "/pose/kettlebell_squat_down",
                },
                {
                    "id": "kettlebell_squat_up",
                    "name": "@kettlebell_squat_up",
                    "icon": "/pose/kettlebell_squat_up",
                },
            ],
            "transitions": [
                {
                    ...
                    "poses": [
                        {"id": "kettlebell_swing_back", "time": 1500},
                        {"id": "kettlebell_swing_forward", "time": 1500},
                    ],
                },
                {
                    "id": "kettlebell_squats",
                    "name": "Sentadilla con kettlebell",
                    "poses": [
                        {"id": "kettlebell_squat_down", "time": 2000},
                        {"id": "kettlebell_squat_up", "time": 2000},
                    ],
                },
            ],
            "sets": [
                ...
                },
                {
                    ...
                    "type": "set_dynamic",
                    "data": {
                        "name": "@kettlebell_squats",
                        "transition": "kettlebell_squats",
                        "repetitions": 12,
                    },
                },
            ],
